    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SimpleLoginActivity.this, SingUp.class));
            }
        });
        ...
        btnlog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getphone.isEmpty() || getUpass.isEmpty()) {
                    Toast.makeText(SimpleLoginActivity.this, "Please Enter your Phone number or password", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.hasChild(getphone)) {
                                ...
                                if (getPassword.equals(getUpass)) {
                                    Toast.makeText(SimpleLoginActivity.this, "Successfully Logged in", Toast.LENGTH_SHORT).show();
                                    ...
                                    // Terminez l'activité de connexion et revenez à l'activité précédente (MapsFragment)
                                    finish();


                                } else {
                                    Toast.makeText(SimpleLoginActivity.this, "Wrong password", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(SimpleLoginActivity.this, "Phone number is not registered", Toast.LENGTH_SHORT).show();
                            }
                        }
